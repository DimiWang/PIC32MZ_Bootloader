...
uint32_t systmrB_freq(TimerB num)
{
    ...
    {
    case TIMER2_TIMER3:
        return SYS_CLK_FREQ / pbdiv / (div[T3CONbits.TCKPS]) / ((uint32_t)PR2 | PR3 << 16);
    case TIMER3:
        return SYS_CLK_FREQ / pbdiv / (div[T3CONbits.TCKPS]) / ((uint32_t)PR3);
    case TIMER2:
        return SYS_CLK_FREQ / pbdiv / (div[T2CONbits.TCKPS]) / ((uint32_t)PR2);
    case TIMER4_TIMER5:
        return SYS_CLK_FREQ / pbdiv / (div[T5CONbits.TCKPS]) / ((uint32_t)PR4 | PR5 << 16);
    case TIMER4:
        return SYS_CLK_FREQ / pbdiv / (div[T4CONbits.TCKPS]) / ((uint32_t)PR4);
    case TIMER5:
        return SYS_CLK_FREQ / pbdiv / (div[T5CONbits.TCKPS]) / ((uint32_t)PR5);
    case TIMER6_TIMER7:
        return SYS_CLK_FREQ / pbdiv / (div[T7CONbits.TCKPS]) / ((uint32_t)PR6 | PR7 << 16);
    case TIMER6:
        return SYS_CLK_FREQ / pbdiv / (div[T6CONbits.TCKPS]) / ((uint32_t)PR6);
    case TIMER7:
        return SYS_CLK_FREQ / pbdiv / (div[T7CONbits.TCKPS]) / ((uint32_t)PR7);
    case TIMER8_TIMER9:
        return SYS_CLK_FREQ / pbdiv / (div[T9CONbits.TCKPS]) / ((uint32_t)PR8 | PR9 << 16);
    case TIMER8:
        return SYS_CLK_FREQ / pbdiv / (div[T8CONbits.TCKPS]) / ((uint32_t)PR8);
    case TIMER9:
        return SYS_CLK_FREQ / pbdiv / (div[T9CONbits.TCKPS]) / ((uint32_t)PR9);
    default:
        break;
    }
    return 0;
...
uint32_t systmrB_elapsed(TimerB num)
{
    ...
    case TIMER2:
        ...
        break;
    case TIMER2_TIMER3:
        return ((uint32_t)TMR2 << 16) | (TMR3 & 0xffff);
        break;
    case TIMER3:
        return (uint32_t)TMR3;
        break;
    case TIMER4:
        return (uint32_t)TMR4;
        break;
    case TIMER4_TIMER5:
        return ((uint32_t)TMR4 << 16) | (TMR5 & 0xffff);
        break;
    case TIMER5:
        return (uint32_t)TMR5;
        break;
    case TIMER6:
        return (uint32_t)TMR6;
        break;
    case TIMER6_TIMER7:
        return ((uint32_t)TMR6 << 16) | (TMR7 & 0xffff);
        break;
    case TIMER7:
        return (uint32_t)TMR7;
        break;
    case TIMER8:
        return (uint32_t)TMR8;
        break;
    case TIMER8_TIMER9:
        return ((uint32_t)TMR8 << 16) | (TMR9 & 0xffff);
        break;
    case TIMER9:
        return (uint32_t)TMR9;
        break;
    default:
        break;
    }
