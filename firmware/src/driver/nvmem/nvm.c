...
void nvm_lock_bootmem()
{
    ...
    NVMKEY = 0xAA996655;
    NVMKEY = 0x556699AA;
    NVMBWP = _NVMBWP_UBWPULOCK_MASK | _NVMBWP_LBWPULOCK_MASK | _NVMBWP_UBWP0_MASK | _NVMBWP_UBWP1_MASK | _NVMBWP_UBWP2_MASK | _NVMBWP_UBWP3_MASK | _NVMBWP_UBWP4_MASK | _NVMBWP_LBWP0_MASK | _NVMBWP_LBWP1_MASK | _NVMBWP_LBWP2_MASK | _NVMBWP_LBWP3_MASK | _NVMBWP_LBWP4_MASK;

    NVMKEY = 0x00000000;
    NVMKEY = 0xAA996655;
    NVMKEY = 0x556699AA;
    NVMBWP =
        _NVMBWP_UBWP0_MASK | _NVMBWP_UBWP1_MASK | _NVMBWP_UBWP2_MASK | _NVMBWP_UBWP3_MASK | _NVMBWP_UBWP4_MASK | _NVMBWP_LBWP0_MASK | _NVMBWP_LBWP1_MASK | _NVMBWP_LBWP2_MASK | _NVMBWP_LBWP3_MASK | _NVMBWP_LBWP4_MASK;
}
